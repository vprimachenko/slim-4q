<template>
  <div class="vc-saturation"
    ...
    <div class="vc-saturation-pointer" :style="{top: pointerTop, left: pointerLeft}">
      <div class="vc-saturation-circle" :style="{background: color}"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    color () {
      return `hsl(${this.colors.hsl.h}, ${100 * this.colors.hsl.s}%, ${100 * this.colors.hsl.l}%)`
    }
  },
  methods: {
...
.vc-saturation-circle {
  ...
  box-shadow: inset 0 0 1px 0px rgba(0,0,0,.3), 0 0 1px 1px rgba(0,0,0,.4);
